...
#define INSTANCE_INDEX_MIN   128
#define INSTANCE_INDEX_MAX   255
...
#define VRAM_CHUNK_INSTANCE_BASE   0x0000
#define VRAM_CHUNK_GRANDE_BASE     0x0010
#define VRAM_CHUNK_VRENDE_BASE     0x0080
#define VRAM_CHUNK_VENTI_BASE      0x00A0
